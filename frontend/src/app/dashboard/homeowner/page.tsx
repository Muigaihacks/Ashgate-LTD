        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Property Owner Dashboard</h1>
            </div>
            <div className="flex items-center gap-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Select a property to manage photos, videos, specifications, and availability.</p>
            </div>
            <button
          ...
          {properties.length === 0 ? (
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center text-gray-600">
              ...
              <p className="text-sm mb-4">You haven&apos;t added any properties yet. Click &ldquo;Add Property&rdquo; to create your first listing.</p>
              <button
                onClick={addNewProperty}
                className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 text-sm font-medium"
              >
          ...
          <div className="space-y-4">
            {properties.map((property) => {
              ...
              return (
                <div
                  key={property.id}
                  className={`border-2 rounded-lg transition-all ${isSelected ? 'border-primary-600 bg-primary-50/60 shadow-sm' : 'border-gray-200 bg-white hover:border-gray-300'}`}
                >
                  <div
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-gray-500">ID: {property.id.replace('property-', '#')}</span>
                      </div>
                    ...
                    <div className="p-5 pt-0 space-y-6">
                      ...
                      <div className="border-t border-gray-200 pt-5">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            ...
                            <h5 className="text-base font-semibold text-gray-900">Property Photos</h5>
                          </div>
                        ...
                        {property.photos.length > 0 ? (
                          ...
                          <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                            ...
                            <p className="text-sm text-gray-500">Select crisp, well-lit photos to boost engagement.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="border-t border-gray-200 pt-5">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            ...
                            <h5 className="text-base font-semibold text-gray-900">Property Videos</h5>
                          </div>
                          <label className="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 cursor-pointer">
                            <Upload className="w-4 h-4" />
                            Select Videos
                        ...
                        {property.videos.length > 0 ? (
                          ...
                          <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                            ...
                            <p className="text-sm text-gray-500">Optional: upload walkthroughs or aerial footage.</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="border-t border-gray-200 pt-5">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h5 className="text-base font-semibold text-gray-900">Property Information</h5>
                        </div>
