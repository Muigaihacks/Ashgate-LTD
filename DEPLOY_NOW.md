...
1. Go back to **Railway dashboard** → Your Laravel service → **"Variables"** tab
...
## 📧 Step 5: Add SMTP Configuration (When Ready)

When you receive the Outlook password:

1. Go to **Railway dashboard** → Your Laravel service → **"Variables"** tab
...
**Next Steps:**
1. ✅ Test all features (login, property creation, etc.)
2. ⏳ Wait for SMTP password and update `MAIL_PASSWORD` in Railway
3. 🧪 Test email functionality (agent onboarding, password reset)
4. 🌐 Set up custom domain `ashgate.co.ke` (optional - see `CUSTOM_DOMAIN_SETUP.md` and `DNS_CONFIGURATION_GUIDE.md`)
